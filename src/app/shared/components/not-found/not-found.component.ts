...
export class NotFoundComponent implements OnInit{
  ...
  //
  //
  //   let yetiTL: TimelineMax;
  //   let chatterTL: TimelineMax;
  //   const furLightColor: string = "#FFF";
  //   const furDarkColor: string = "#67b1e0";
  //   const skinLightColor: string = "#ddf1fa";
  //   const skinDarkColor: string = "#88c9f2";
  //   const lettersSideLight: string = "#3A7199";
  //   const lettersSideDark: string = "#051d2c";
  //   const lettersFrontLight: string = "#67B1E0";
  //   const lettersFrontDark: string = "#051d2c";
  //   const lettersStrokeLight: string = "#265D85";
  //   const lettersStrokeDark: string = "#031219";
  //   const mouthShape1: string = "M149 115.7c-4.6 3.7-6.6 9.8-5 15.6.1.5.3 1.1.5 1.6.6 1.5 2.4 2.3 3.9 1.7l11.2-4.4 11.2-4.4c1.5-.6 2.3-2.4 1.7-3.9-.2-.5-.4-1-.7-1.5-2.8-5.2-8.4-8.3-14.1-7.9-3.7.2-5.9 1.1-8.7 3.2";
  //   const mouthShape2: string = "M161.2 118.9c0 2.2-1.8 4-4 4s-4-1.8-4-4c0-1 .4-2 1.1-2.7.7-.8 1.8-1.3 2.9-1.3 2.2 0 4 1.7 4 4";
  //   const mouthShape3: string = "M150.2 118.3c-4.6 3.7-7.5 6.4-6.3 12.3.1.5.1.6.3 1.1.6 1.5 2.4 2.3 3.9 1.7 0 0 7.9-4.3 10.7-5.5s11.6-3.3 11.6-3.3c1.5-.6 2.3-2.4 1.7-3.9-.2-.5-.2-.6-.4-1.1-2.8-5.2-7.1-4.9-12.9-4.6-3.7.4-6.3 1.5-8.6 3.3";
  //   const mouthShape4: string = "M149.2 116.7c-4.6 3.7-6.7 8.8-5.2 14.6.1.3.1.5.2.8.6 1.5 2.4 2.3 3.9 1.7l11.2-4.4 11.2-4.4c1.5-.6 2.3-2.4 1.7-3.9-.1-.3-.2-.5-.4-.7-2.8-5.2-8.2-7.2-14-6.9-3.6.2-5.9 1.1-8.6 3.2";
  //
